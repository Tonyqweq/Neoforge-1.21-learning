...
public class ModLootTablesProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        //dropSelf(ModBlocks.STAR_POINT_BLOCK.get());
        add(ModBlocks.STAR_POINT_BLOCK.get(),
                block -> createCopperOreLikeDrops(ModBlocks.STAR_POINT_BLOCK.get(), ModItems.STAR_POINT.get(),2.0f,5.0f));
